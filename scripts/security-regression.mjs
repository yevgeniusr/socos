...
const task16SecretEnvNamePattern =
  /\b(?:GOOGLE_CALENDAR_CLIENT_ID|GOOGLE_CALENDAR_CLIENT_SECRET|GOOGLE_CALENDAR_REDIRECT_URI|GOOGLE_CALENDAR_WEBHOOK_URL|GOOGLE_CALENDAR_SETTINGS_RESULT_URL|GOOGLE_CALENDAR_CALLBACK_SECRET|OWNTRACKS_WEBHOOK_SECRET|PERSONAL_DATA_KEYS|PERSONAL_DATA_INDEX_KEY|PERSONAL_DATA_ACTIVE_KEY_VERSION|EVENT_SOURCE_ALLOWED_HOSTS|CALENDAR_SYNC_ENABLED|LOCATION_INGEST_ENABLED|EVENT_DISCOVERY_ENABLED|EVENT_BRIEF_ENABLED)\b/;
const dockerBuildSecretSurfacePattern =
  /^\s*(?:ARG|ENV)\s+.*(?:GOOGLE_CALENDAR_CLIENT_ID|GOOGLE_CALENDAR_CLIENT_SECRET|GOOGLE_CALENDAR_REDIRECT_URI|GOOGLE_CALENDAR_WEBHOOK_URL|GOOGLE_CALENDAR_SETTINGS_RESULT_URL|GOOGLE_CALENDAR_CALLBACK_SECRET|OWNTRACKS_WEBHOOK_SECRET|PERSONAL_DATA_KEYS|PERSONAL_DATA_INDEX_KEY|PERSONAL_DATA_ACTIVE_KEY_VERSION|EVENT_SOURCE_ALLOWED_HOSTS|CALENDAR_SYNC_ENABLED|LOCATION_INGEST_ENABLED|EVENT_DISCOVERY_ENABLED|EVENT_BRIEF_ENABLED)/m;
